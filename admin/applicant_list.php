...
<body>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                                <div class="row">
                                                    <div class="col-sm-12">
													<table id="tblApplicants" class="display table table-striped table-hover" cellspacing="0" width="100%">
														<thead>
															<tr>
																<th>#</th>
	...
	<script>
		...
		$(document).ready(function(){
			var current_Table = '#tblApplicants';

			$(current_Table).DataTable();

			fillApplicantList(current_Table)
