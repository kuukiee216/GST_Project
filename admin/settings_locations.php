...
<body>
    <div class="wrapper">
		...
		<!-- Modal -->
		<div class="modal fade" id="modalAddLocation" tabindex="-1" role="dialog" aria-labelledby="modalAddLocation" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h3 class="modal-title">Add Location</h3>
									<button type="button" class="close d-none d-sm-none" data-dismiss="modal" aria-label="Close" id="btnCloseAddLocationForm">
										<span aria-hidden="true">&times;</span>
									</button>
									<button type="button" class="close" onclick="closeAddLocationsForm();">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
