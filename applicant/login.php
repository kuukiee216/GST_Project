                                ...
                                <div class="dropdown-user-scroll scrollbar-outer scroll-content"
                                    ...
                                    <li>
                                        <div class="user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>Meow</h4>
                                                <p class="text-muted">Genesis.com</p><a href="profile.html"
                        ...
                        <form class="d-flex">
                            <div>
                                <a class="text-white nav-link"
                                    href="/FILES-Recruiter Side/dashboard_recruiter.html">Recruiter Site</a>
                            </div>
                        </form>
                    </li>
                </ul>
                                ...
                                <div class="card p-5">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <form id="formLogin">
                                                <div class="form-group">
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="email" id="txtUserID" name="txtUserID"
                                        ...
                                        <div class="row">
                                            ...
                                            <button type="button" class="btn btn-danger btn-round btn-block mt-4"
                                                id="btnLogin" onclick="Login('formLogin');">Sign In</button>
                                        </div>
                                        ...
                                        <div class="row">
                                            <button type="button"
                                                class="btn btn-default btn-round btn-border btn-block d-flex align-items-center justify-content-start"
                                                id="" onclick="">
                                            ...
                                            <button class="btn btn-block btn-link"
                                                onclick="window.location.href='register.php'">Don't have an account?
                                                <span class="text-primary">Sign Up</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
