  ...
  <body>
        ...
        <div class="mb-3">
            <label for="InputPassword" class="form-label">Password</label>
                ...
                <input type="password" class="form-control mb-3" id="ReEnterPassword">
                <button type="submit" class="btn btn-danger mt-4" value="register">Register</button>
            ...
            <div class="mb-3">
                ...
                <button class="text-start btn btn-white mt-4 border border-secondary" type="submit">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 50 50">
                    ...
                    <div class="mt-3">
                      <p>Already on JAPAN JOBS? <a class="form-label" href="/FILES-Applicant Side/SignIn.html">Sign In</a></p>
                    </div>
                </div>
            </div>
