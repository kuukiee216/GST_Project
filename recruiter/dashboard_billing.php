...
<body>
    ...
    <div class="container pt-4 pb-5" style="width: 50%;">
        ...
        <h4 class="pt-4"><b>Payment Method</b></h4>
                ...
                <div class="row row-cols-3 text-start">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="text-muted">ALL JAPAN JOBS invoices for your company will be sent to your
                                billing email.</div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalChangeEmail">Change Billing Address
                                            </h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button onclick="ChangeAccountDetails('changeBillingForm');"
                                                id="btnChangeAcount" type="submit" class="btn btn-primary">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <h4 class="pt-4"><b>Subscriptions</b></h4>
        ...
        <div class="container pt-4 pb-4">
            <h4 class="pt-3"><b>Billing Details</b></h4>
            <div class="card">
                <div class="card-body">
                    <div class="row row-cols-3 text-start">
