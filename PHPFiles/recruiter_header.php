<nav class="navbar navbar-expand-lg" style="background-color:#187498">
    <div class="container-fluid">
        <!-- Brand/logo -->
        <a href="../recruiter/dashboard_recruiter.php" class="navbar-brand">
            <img src="../assets/img/JapanJobs.png" alt="Japan Jobs" style="height: 40px;">
        </a>
                            ...
                            <div class="dropdown-user-scroll scrollbar-outer scroll-content"
                                ...
                                <li>
                                    <div class="user-box">
                                        ...
                                        <div class="u-text">
                                            <h4>Meow</h4>
                                            <p class="text-muted">Genesis.com</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
